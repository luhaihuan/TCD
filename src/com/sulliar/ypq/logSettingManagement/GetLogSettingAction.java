...
// Source File Name:   GetLogSettingAction.java
...
public class GetLogSettingAction extends ActionSupport
{
		...
		throws Exception
	{
		...
		if (ls != null)
		{
			day = Double.parseDouble(ls.getValue());
			success = true;
		} else
		{
			success = false;
