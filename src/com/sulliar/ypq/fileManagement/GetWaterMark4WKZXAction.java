...
public class GetWaterMark4WKZXAction extends ActionSupport
{
	...
	public GetWaterMark4WKZXAction()
	{
	}
		...
		throws Exception
	{
		...
		/*if(department!=null)
		images = fileManager.getWaterMark("", department.getDepartment_name());//session is null
