...
public class GetSearchItemAction extends ActionSupport
{
		...
		throws Exception
	{
		...
		itemModel.setSearchType(query_type);
		itemModel.setItem_id("Item_id");
		itemModel.setItem_id_new("Item_id_new");
		itemModel.setItem_id_old("Item_id_old");
		itemModel.setItem_name("Item_name");
		itemModel.setObject_code("Object_code");
		itemModel.setItem_revision("Item_revision");
		itemModel.setFilePath("FilePath");
		items.add(itemModel);*/
		total = items.size();
		limit = total;
		start = 0;
	...
	public String toString() {
		return "GetSearchItemActionLHH [flag=" + flag + ", items=" + items
