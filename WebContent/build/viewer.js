...
var DEFAULT_URL = 'http://10.2.1.58:8088/TCD/build/88292008-211_00_PDF.pdf';
var projectPath = 'http://localhost:8080/testWeb3/';
...
PDFJS.imageResourcesPath = server_context+'build/images/';
  PDFJS.workerSrc = server_context+'build/pdf.worker.js';
  PDFJS.cMapUrl = server_context+'build/cmaps/';
...
function openUrlPdfFile(filePath) {
	if(filePath != null &&  filePath !="") {
		DEFAULT_URL = filePath;
